<html lang="es">
  ...
  <head>
     <meta charset="utf-8">
     <title> cronograma-cancelar</title>
   ...
   <div id="border">
    ...
    <br>
	 ...
	 <div class="modi2">
	    ...
	    Seleccione la fecha del registro que desea <br>cancelar <br>
       <select id="pregunta3">
        ...
        Ingrese nombre del registro que desea cancelar<br><input type="text" ><br>
